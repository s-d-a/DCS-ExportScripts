...
ExportScript.ConfigEveryFrameArguments = 
{
	...
	--[329] = "%.4f", --unused
	--[330] = "%.4f", --unused
	[331] = "%.4f", --Some Stick pipe that goes from the door to the pilot chair ???
	--[332] = "%.4f", --unused
	[334] = "%.4f", --unknown
	--[335] = "%.4f", --unused
	[336] = "%.4f", --Some Stick pipe that goes from the door to the pilot chair ???
	[337] = "%.4f", --unknown
	[338] = "%.4f", --unknown
	[339] = "%.4f", --unknown
	[340] = "%.4f", --unknown
	[341] = "%.4f", --unknown
	--[342] = "%.4f", --unused
	[343] = "%.4f", --Maybe a red light
	[344] = "%.4f", --Maybe a green light
	[345] = "%.4f", --Maybe a red light
	[346] = "%.4f", --Maybe a green light
	[347] = "%.4f", --unknown
	[348] = "%.4f", --unknown
	[349] = "%.4f", --unknown
	[350] = "%.4f", --unknown
	...
	[373] = "%.4f", --unknown
	--[374] = "%.4f", --unused
	[375] = "%.4f", --Clock Timer hours
	[376] = "%.4f", --Clock Timer minutes
	[377] = "%.4f", --unknown
	[378] = "%.4f", --unknown
	[379] = "%.4f", --unknown
	[380] = "%.4f", --unknown
	[381] = "%.4f", --Voltimeter warning light cover
	[382] = "%.4f", --Voltimeter warning glare
}
